...
technique11 T0
{
    ...
    //Deffered - SpotLights
    P_RS_VTP(P6, Deffered_Rasterizer_State, VS_SpotLights, HS_SpotLights, DS_SpotLights, PS_SpotLights_Debug)
    ...
    P_RS_VP(P8, Deffered_Rasterizer_State, VS_Depth_Mesh, PS_Depth)
    P_RS_VP(P9, Deffered_Rasterizer_State, VS_Depth_Model, PS_Depth)
    P_RS_VP(P10, Deffered_Rasterizer_State, VS_Depth_Animation, PS_Depth)
}