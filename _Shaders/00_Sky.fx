...
float4 PS_CubeSky(MeshOutput input) : SV_Target
{
...
// Vertex Shader
////////////////////////////////////////////////////////////////////////////////
VertexOutputType SkyPlaneVertexShader(VertexInputType input)
{
...
VertexOutputType VS_PreRender_Reflection_SkyPlaneVertexShader(VertexInputType input)
{
	VertexOutputType output;
...
Texture2D perturbTexture;
//SamplerState SampleType;

cbuffer CB_SkyBuffer
{
	float translation;
	float scale;
	float brightness;
...
// Pixel Shader
////////////////////////////////////////////////////////////////////////////////
float4 SkyPlanePixelShader(VertexOutputType input) : SV_TARGET
{
	float4 perturbValue;
	float4 cloudColor;
	...
	perturbValue = perturbTexture.Sample(LinearSampler, input.tex);
