...
void DefferedSpotLightDemo::Initialize()
{
	...
	shader = new Shader(L"45_SpotLights.fxo");
	gBuffer = new GBuffer(shader);
	//gBuffer->SetDebug(true);
...
void DefferedSpotLightDemo::Destroy()
{
	
}

void DefferedSpotLightDemo::Update()
{
	sky->Update();
...
void DefferedSpotLightDemo::PreRender()
{
	//GBuffer
	{
		gBuffer->PackGBuffer();
...
void DefferedSpotLightDemo::Render()
{
	//sky->Pass(0);
	//sky->Render();
...
void DefferedSpotLightDemo::PostRender()
{
	gBuffer->DebugRender();
}

void DefferedSpotLightDemo::Mesh()
{
	//Create Material
	{
...
void DefferedSpotLightDemo::Airplane()
{
...
void DefferedSpotLightDemo::Kachujin()
{
	weapon = new Model();
...
void DefferedSpotLightDemo::Pass(UINT mesh, UINT model, UINT anim)
{
...
void DefferedSpotLightDemo::AddPointLights()
{
	PointLight light;
	light =
	{
	...
	for (float z = -60; z <= 60; z += 12)
	{
		for (float x = -60; x <= 60; x += 12)
		{
			light =
			{
				Color(0, 0, 0, 1),
...
void DefferedSpotLightDemo::AddSpotLights()
{
	SpotLight light;
	light =
	{
